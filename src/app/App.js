...
class App extends Component{
    ...
    deleteTask(id){
        if(confirm('Are you sure about this? D:')){
            fetch(`/api/tasks/${id}`, {
                method: 'DELETE',
                headers: {
                    'Accept': 'application/json',
                                            ...
                                            return  (
                                                <tr key={task._id}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button onClick={()=>this.deleteTask(task._id)} className="btn light-blue darken-4" style={{margin: '5px'}}><i className="material-icons">delete</i></button>
                                                    </td>
                                                </tr>
                                            )
                                        })
